<!-- source: https://developers.figma.com/docs/plugins/api/FrameNode -->
...
The frame node is a container used to define a layout hierarchy. It is similar to `<div>` in HTML. It is different from [`GroupNode`](GroupNode.md), which is closer to a folder for layers. Frames can be created using [`figma.createFrame`](properties/figma-createframe.md).
...
## Frame properties[​](#frame-properties "Direct link to Frame properties")
