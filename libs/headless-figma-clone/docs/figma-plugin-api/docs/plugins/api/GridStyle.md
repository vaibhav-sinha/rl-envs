...
List of [`LayoutGrid`](LayoutGrid.md) to replace the `layoutGrids` property with.

---

### boundVariables?: { readonly [field in [VariableBindableGridStyleField](VariableBindableGridStyleField.md)]?: [VariableAlias](VariableAlias.md)[]} [readonly]
...
EffectStyle](EffectStyle.md)[Next
