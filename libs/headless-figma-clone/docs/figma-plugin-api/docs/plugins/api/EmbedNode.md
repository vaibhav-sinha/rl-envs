<!-- source: https://developers.figma.com/docs/plugins/api/EmbedNode -->
...
Represents an embed node in FigJam. A embed node is one that can be activated to host an iframe of another website inside the FigJam canvas. Embeds can be created using [`figma.createLinkPreviewAsync`](properties/figma-createlinkpreviewasync.md).

## Embed properties[​](#embed-properties "Direct link to Embed properties")
...
### embedData: [EmbedData](EmbedData.md) [readonly]

Readonly metadata about this particular embed

---

### clone(): [EmbedNode](EmbedNode.md)
...
EllipseNode](EllipseNode.md)[Next
