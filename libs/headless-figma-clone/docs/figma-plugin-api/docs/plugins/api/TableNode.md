<!-- source: https://developers.figma.com/docs/plugins/api/TableNode -->
...
Tables can be used to structure your content. These nodes can be created using [`figma.createTable`](properties/figma-createtable.md).
...
### cellAt(rowIndex: number, columnIndex: number): [TableCellNode](TableCellNode.md)

Returns the table cell node at a specific cell coordinate.

[View more →](properties/TableNode-cellat.md)
...
[View more →](properties/TableNode-insertrow.md)
...
[View more →](properties/TableNode-insertcolumn.md)
...
[View more →](properties/TableNode-removerow.md)
...
[View more →](properties/TableNode-removecolumn.md)
...
[View more →](properties/TableNode-moverow.md)
...
[View more →](properties/TableNode-movecolumn.md)
...
[View more →](properties/TableNode-resizerow.md)
...
[View more →](properties/TableNode-resizecolumn.md)
...
cellAt](properties/TableNode-cellat.md)
