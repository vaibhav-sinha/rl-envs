<!-- source: https://developers.figma.com/docs/plugins/api/MediaNode -->
...
Represents an media node in FigJam. A media node is one that can be activated to play rich media inside the FigJam canvas, can be created using [`figma.createGif`](properties/figma-creategif.md).
...
### mediaData: [MediaData](MediaData.md) [readonly]
...
[View more →](properties/MediaNode-resize.md)
...
[View more →](properties/MediaNode-resizewithoutconstraints.md)

---

### clone(): [MediaNode](MediaNode.md)
...
LinkUnfurlNode](LinkUnfurlNode.md)[Next

resize](properties/MediaNode-resize.md)
