...
A transform group node has all the properties of a [GroupNode](GroupNode.md), as well as an additional `transformModifiers` property. This property is an array of [TransformModifier](TransformModifier.md) objects that define how the child nodes are transformed within the group.

A transform group can be created using the [figma.transformGroup](properties/figma-transformgroup.md) method.
...
### clone(): [TransformGroupNode](TransformGroupNode.md)
...
### transformModifiers: [TransformModifier](TransformModifier.md)[]
...
autoRename](properties/TextPathNode-autorename.md)[Next
