<!-- source: https://developers.figma.com/docs/plugins/api/CodeBlockNode -->
...
A code block object. Code blocks can be created using [`figma.createCodeBlock`](figma.md#createcodeblock).

## Code block properties[​](#code-block-properties "Direct link to Code block properties")
...
### clone(): [CodeBlockNode](CodeBlockNode.md)
...
BooleanOperationNode](BooleanOperationNode.md)[Next
