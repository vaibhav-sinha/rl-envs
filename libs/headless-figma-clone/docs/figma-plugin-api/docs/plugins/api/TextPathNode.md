<!-- source: https://developers.figma.com/docs/plugins/api/TextPathNode -->
...
A text path node allows text to follow along a vector path while maintaining text styling capabilities. Like regular [text nodes](TextNode.md), text paths have styling properties such as color (fills), font size, and font name that can be applied to either the entire node or individual character ranges.

Text paths have a subset of the properties from [Text Nodes](TextNode.md), as well as a few path-specific properties that define the underlying vector geometry. When working with text, there are a lot of things to consider, including mixed styles, loading fonts, and missing fonts. Please refer to the [Working with Text](../working-with-text.md) page for more information.

## Text path node properties[​](#text-path-node-properties "Direct link to Text path node properties")
...
### textPathStartData: [TextPathStartData](TextPathStartData.md)

A data structure defining where the text starts along the path.

---

### clone(): [TextPathNode](TextPathNode.md)
...
### [autoRename](properties/TextPathNode-autorename.md): boolean
...
[View more →](properties/TextPathNode-autorename.md)

---

## Path-related properties[​](#path-related-properties "Direct link to Path-related properties")

### vectorPaths: [VectorPaths](VectorPath.md#vector-paths) [readonly]

The vector paths of the text path node.

---

### vectorNetwork: [VectorNetwork](VectorNetwork.md) [readonly]

The vector network of the text path node.

---

### handleMirroring: [HandleMirroring](HandleMirroring.md) | [figma.mixed](properties/figma-mixed.md) [readonly]
...
If the manifest contains`"documentAccess": "dynamic-page"`, this property is read-only. Use [`setTextStyleIdAsync`](TextPathNode.md#settextstyleidasync) to update the style.
...
autoRename](properties/TextNode-autorename.md)[Next

autoRename](properties/TextPathNode-autorename.md)

- [Text path node properties](#text-path-node-properties)
- [Path-related properties](#path-related-properties)
