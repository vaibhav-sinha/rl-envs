<!-- source: https://developers.figma.com/docs/plugins/api/PolygonNode -->
...
The polygon node allows you to create a regular convex polygon with three or more sides. Polygons can be created using [`figma.createPolygon`](properties/figma-createpolygon.md).

## Polygon properties[​](#polygon-properties "Direct link to Polygon properties")
...
### clone(): [PolygonNode](PolygonNode.md)
...
focusedNode](properties/PageNode-focusednode.md)[Next
