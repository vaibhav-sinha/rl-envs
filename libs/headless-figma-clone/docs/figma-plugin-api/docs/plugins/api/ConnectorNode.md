<!-- source: https://developers.figma.com/docs/plugins/api/ConnectorNode -->
...
A connector is used to connect FigJam components to indicate relationships. Connectors can be created using [`figma.createConnector`](properties/figma-createconnector.md).
...
### textBackground: [LabelSublayerNode](LabelSublayer.md#label-sublayer-node) [readonly]
...
### connectorStartStrokeCap: [ConnectorStrokeCap](ConnectorStrokeCap.md)

Connector start stroke cap

---

### connectorEndStrokeCap: [ConnectorStrokeCap](ConnectorStrokeCap.md)

Connector end stroke cap

---

### [rotation](properties/ConnectorNode-rotation.md): number
...
[View more →](properties/ConnectorNode-rotation.md)

---

### clone(): [ConnectorNode](ConnectorNode.md)
...
ComponentSetNode](ComponentSetNode.md)[Next

rotation](properties/ConnectorNode-rotation.md)
