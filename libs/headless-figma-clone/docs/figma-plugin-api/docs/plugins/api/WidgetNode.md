<!-- source: https://developers.figma.com/docs/plugins/api/WidgetNode -->
...
## Widget properties[​](#widget-properties "Direct link to Widget properties")
...
### clone(): [WidgetNode](WidgetNode.md)
...
[View more →](properties/WidgetNode-clonewidget.md)

---

### [setWidgetSyncedState](properties/WidgetNode-setwidgetsyncedstate.md)(syncedState: { [name: string]: any }, syncedMap?: { [mapName: string]: { [key: string]: any } }): void
...
[View more →](properties/WidgetNode-setwidgetsyncedstate.md)
...
WashiTapeNode](WashiTapeNode.md)[Next

cloneWidget](properties/WidgetNode-clonewidget.md)
