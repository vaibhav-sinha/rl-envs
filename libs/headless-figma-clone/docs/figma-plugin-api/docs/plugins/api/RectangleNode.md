<!-- source: https://developers.figma.com/docs/plugins/api/RectangleNode -->
...
The rectangle is one of the most commonly used shapes in Figma. A notable feature it has over other kinds of shapes is the ability to specify independent corner radius values. Rectangles can be created using [`figma.createRectangle`](properties/figma-createrectangle.md).

## Rectangle properties[​](#rectangle-properties "Direct link to Rectangle properties")
...
PolygonNode](PolygonNode.md)[Next
