...
Components are UI elements that can be reused across your designs. They are like frames, with the additional ability to have auto-updating copies called instances (see [`InstanceNode`](InstanceNode.md)).

The file may already contain instances of this frame, or you might create them via [`createInstance`](ComponentNode.md#createinstance). When you set a property on a component (or change its content), all instances of that component will update.
...
### clone(): [ComponentNode](ComponentNode.md)
...
### createSlot(): [SlotNode](SlotNode.md)

Creates a new slot node within this component.

---

### getInstancesAsync(): Promise<[InstanceNode](InstanceNode.md)[]>

Returns an array of all of the instances of this component in the document.

---

### instances: [InstanceNode](InstanceNode.md)[] [readonly]

**DEPRECATED:** Use [`getInstancesAsync`](ComponentNode.md#getinstancesasync) instead. Accessing this property will throw an exception if the plugin manifest contains `"documentAccess": "dynamic-page"`.
...
CodeBlockNode](CodeBlockNode.md)[Next
