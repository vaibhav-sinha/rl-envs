<!-- source: https://developers.figma.com/docs/plugins/api/SlideNode -->
...
Slides can be created using [`figma.createSlide`](properties/figma-createslide.md).

We currently do not support Slides being top level nodes on the Canvas; Slides must be direct children of Slide Rows.

## Slide properties[​](#slide-properties "Direct link to Slide properties")
...
### clone(): [SlideNode](SlideNode.md)

Create a copy of this node. By default, the duplicate will be parented under `figma.currentPage`.

---

### getSlideTransition(): [SlideTransition](SlideTransition.md)

Get the [`SlideTransition`](SlideTransition.md) of the slide node.

---

### setSlideTransition(transition: [SlideTransition](SlideTransition.md)): void

Set the [`SlideTransition`](SlideTransition.md) of the slide node.
...
SlideGridNode](SlideGridNode.md)[Next
