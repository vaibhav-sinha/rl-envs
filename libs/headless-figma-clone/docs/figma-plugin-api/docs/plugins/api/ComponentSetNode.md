<!-- source: https://developers.figma.com/docs/plugins/api/ComponentSetNode -->
...
A component set contains the variants of a component. It behaves much like a normal frame would, but all of its children are [`ComponentNode`](ComponentNode.md)s.

Be aware that some component sets reflect items in the team library that are used within this file. Those component sets and their children are read-only, though you may create new instances of the [`ComponentNode`](ComponentNode.md)s that are inside them.

In Figma, component sets must always have children. A component set with no children will delete itself.

## Component set properties[​](#component-set-properties "Direct link to Component set properties")
...
### clone(): [ComponentSetNode](ComponentSetNode.md)
...
### defaultVariant: [ComponentNode](ComponentNode.md) [readonly]
...
ComponentNode](ComponentNode.md)[Next

ConnectorNode](ConnectorNode.md)

- [Component set properties](#component-set-properties)
