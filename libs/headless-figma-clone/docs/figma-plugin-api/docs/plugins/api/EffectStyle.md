<!-- source: https://developers.figma.com/docs/plugins/api/EffectStyle -->
...
## EffectStyle[​](#effectstyle "Direct link to EffectStyle")
...
List of [`Effect`](Effect.md) to replace the `effects` property with.

---

### boundVariables?: { readonly [field in [VariableBindableEffectStyleField](VariableBindableEffectStyleField.md)]?: [VariableAlias](VariableAlias.md)[]} [readonly]
