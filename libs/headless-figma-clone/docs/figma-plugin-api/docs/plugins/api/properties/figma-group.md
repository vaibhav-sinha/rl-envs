...
### [group](figma-group.md)(nodes: ReadonlyArray<[BaseNode](../nodes.md#base-node)>, parent: [BaseNode](../nodes.md#base-node) & [ChildrenMixin](../node-properties.md#children-mixin), index?: number): [GroupNode](../GroupNode.md)
...
combineAsVariants](figma-combineasvariants.md)[Next

transformGroup](figma-transformgroup.md)
