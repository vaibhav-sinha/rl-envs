<!-- source: https://developers.figma.com/docs/plugins/api/StarNode -->
...
The star node allows you to create a star with a set number of points. Stars can be created using [`figma.createStar`](properties/figma-createstar.md).

## Star properties[​](#star-properties "Direct link to Star properties")
...
StampNode](StampNode.md)[Next

StickyNode](StickyNode.md)

- [Star properties](#star-properties)
