<!-- source: https://developers.figma.com/docs/plugins/api/InstanceNode -->
...
Instances are a copy of a component (see [`ComponentNode`](ComponentNode.md)). They will always be automatically updated if a component is modified. Instances can be created using the [`createInstance`](ComponentNode.md#createinstance) method on any component node.
...
### clone(): [InstanceNode](InstanceNode.md)
...
### getMainComponentAsync(): Promise<[ComponentNode](ComponentNode.md) | null>
...
### mainComponent: [ComponentNode](ComponentNode.md) | null

The component that this instance reflects. This could be a remote, read-only component. This can be set to turn this instance into a different component. On nested instances (instances inside other instances), setting this value clears all overrides and performs nested instance swapping.

If the plugin manifest contains `"documentAccess": "dynamic-page"`, this property is **write-only**. Use [`getMainComponentAsync`](InstanceNode.md#getmaincomponentasync) to read the value.

---

### [swapComponent](properties/InstanceNode-swapcomponent.md)(componentNode: [ComponentNode](ComponentNode.md)): void
...
[View more →](properties/InstanceNode-swapcomponent.md)

---

### setProperties(properties: { [propertyName: string]: string | boolean | [VariableAlias](VariableAlias.md) }): void
...
### componentProperties: [ComponentProperties](ComponentProperties.md) [readonly]
...
### [scaleFactor](properties/InstanceNode-scalefactor.md): number

The scale factor applied to the instance.

[View more →](properties/InstanceNode-scalefactor.md)

---

### exposedInstances: [InstanceNode](InstanceNode.md)[] [readonly]
...
### overrides: { id: string; overriddenFields: [NodeChangeProperty](NodeChangeProperty.md)[] }[] [readonly]
...
HighlightNode](HighlightNode.md)[Next

swapComponent](properties/InstanceNode-swapcomponent.md)
